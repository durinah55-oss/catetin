...
// --- submit channels: tunai masuk laci (KSM = ojek_online) ---
...
const { report: r1, txs: t1 } = submitDailyReport(state1, {
  channels: { tunai: 500000, qris_bca: 100000, ojek_online: 50000 },
  date: "2026-06-18",
...
ok(t2.some(t => t.walletId === "w_gofood" && t.amount === 50000), "Ojek online ke Go Food");
...
const { report: rResub, txs: tResub, removeIds } = resubmitDailyReport(stateRev, r1.id, {
  channels: { tunai: 550000, qris_bca: 100000, ojek_online: 50000 },
  date: "2026-06-18",
  user: { id: "u3", name: "Kasir", outlet: "KSM" },
});
