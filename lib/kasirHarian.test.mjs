...
ok(fixed21.transactions.some((t) => t.id === "t_dr1782078708796_cash"), "tx tunai dipulihkan");
ok(!fixed21.deletedTransactionIds.includes("t_dr1782078708796_cash"), "tombstone cash dihapus");
