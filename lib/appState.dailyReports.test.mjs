...
ok(
  pickNewerDailyReport(submittedKbu, revisionFresh).status === "revision_requested",
  "pickNewerDailyReport: revisi admin menang atas submitted stale (KBU 21 Jun)"
);
ok(
  pickNewerDailyReport(revisionFresh, {
    ...revisionFresh,
    status: "submitted",
    resubmittedAt: "2026-06-22T12:00:00.000Z",
    revisionNote: null,
  }).status === "submitted",
  "pickNewerDailyReport: kirim revisi kasir menang atas revision_requested"
);
