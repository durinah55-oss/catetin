...
test("NF laba contoh user: omzet kotor − HPP − opex", () => {
  const txs = [
    ...
    { id: "2", type: "out", amount: 5_000_000, categoryId: id("Retur & komplain"), date: "2026-07-02" },
    { id: "3", type: "out", amount: 35_000_000, categoryId: id("Bahan produk"), date: "2026-07-03" },
    { id: "4", type: "out", amount: 30_000_000, categoryId: id("Karyawan"), date: "2026-07-04" },
  ];
...
test("NF prive tidak mengurangi laba bersih", () => {
  const txs = [
    ...
    { id: "2", type: "out", amount: 2_000_000, categoryId: id("Uang owner"), date: "2026-07-02" },
  ];
  const r = computeNfProfit(txs, cats, { start: "2026-07-01", end: "2026-07-31" });
...
test("peringatan dobel marketplace jika pemasukan bersih + fee", () => {
  const txs = [
    ...
    { id: "2", type: "out", amount: 1_500_000, categoryId: id("Biaya marketplace"), date: "2026-07-01" },
  ];
  const r = computeNfProfit(txs, cats, { start: "2026-07-01", end: "2026-07-31" });
